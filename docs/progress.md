...
| 11. TEST-E2E | in-progress | New coverage against the seeded corpus specifically (demo login → populated Knowledge Base/Service Map/Dashboard, not empty-state; open a precomputed-brief incident; demo guest generates a new brief) |
| 12. PUSH | pending | |
| 13. PR | pending | |
| 14. MERGE | pending | |
