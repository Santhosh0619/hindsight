...
export const SCREENS: ScreenDef[] = [
  { path: "/dashboard", label: "Dashboard", phase: 10, implemented: true },
  { path: "/incidents/new", label: "New Incident", phase: 9, implemented: true },
  { path: "/incidents", label: "Incidents", phase: 9, implemented: true },
  { path: "/knowledge-base", label: "Knowledge Base", phase: 10, implemented: true },
  { path: "/service-map", label: "Service Map", phase: 10, implemented: true },
  { path: "/search", label: "Search", phase: 7, implemented: true },
  { path: "/evaluation", label: "Evaluation", phase: 12, implemented: true },
  { path: "/agent-runs", label: "Agent Runs", phase: 13, implemented: true },
  { path: "/settings", label: "Settings", phase: 13, implemented: true },
  { path: "/audit-log", label: "Audit Log", phase: 13, implemented: true },
];
